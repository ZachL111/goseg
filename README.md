...
goseg is a Go project for storage. It focuses on this technical goal: Build segmented append-only logs with index rebuild and compaction planning.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 174, risk penalty 7, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
